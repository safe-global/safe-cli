...
class AssetsEngine:
    """ Data Artifacts
    This class will stored common eth_assets such as account_artifacts, payload_artifacts, token_artifacts
    & contract_artifacts
    """
    ...
    def artifact_selection(self, artifact_type):
        ...
        elif artifact_type == 'contract_cli':
    ...
    def from_alias_get_value(self, stream_value, artifact_type=None):
        ...
        for the console (account, contract_cli, paload, token)
        :param stream_value:
        :param artifact_type:
        :return:
        """
