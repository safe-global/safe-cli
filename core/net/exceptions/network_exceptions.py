...
class NetworkAgentMissingApiKey(Exception):
    """ NetworkAgentMissingApiKey
    Raised when the Network Agent is unable to set EndPoint
    ...
    def __init__(self, _network_agent, err, _trace, *args):
        ...
        super(NetworkAgentMissingApiKey, self).__init__(self.message, err, _network_agent, *args)
