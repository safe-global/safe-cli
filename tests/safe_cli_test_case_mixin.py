...
class SafeCliTestCaseMixin:
    ...
    def deploy_test_safe_v1_3_0(self, number_owners: int = 3, threshold: Optional[int] = None,
        ...
        initializer = HexBytes(
            get_safe_V1_3_0_contract(self.w3, address=NULL_ADDRESS).functions.setup(
        ...
        ethereum_tx_sent = self.proxy_factory.deploy_proxy_contract(
            self.ethereum_test_account, self.safe_contract_V1_3_0_address,
    ...
    def setup_operator(self, number_owners: int = 1,
