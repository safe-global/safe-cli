...
def deploy_gnosis_safe_v1_1_1():
    ...
    safe_v111_abi, safe_v111_bytecode, safe_v111 = contract_reader.read_from(
        './core/eth_assets/assets/safe/GnosisSafeV1.1.1.json')
...
def deploy_gnosis_safe_v1_1_0():
    ...
    local_account = Account.privateKeyToAccount('0x4f3edf983ac636a65a842ce7c78d9aa706d3b113bce9c46f30d7d21715b23b1d')
    safe_v101_abi, safe_v101_bytecode, safe_v101 = contract_reader.read_from('./core/eth_assets/assets/safe/GnosisSafeV1.1.0.json')
    proxy_v101_abi, proxy_v101_bytecode, proxy_v101 = contract_reader.read_from('./core/eth_assets/assets/safe/Proxy.json')
