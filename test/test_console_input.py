...
def test_get_send_ether():
    send_ether_command = 'sendEther --address=0xD833215cBcc3f914bD1C9ece3EE7BF8B14f841bb ' \
...
def test_get_withdraw_ether():
    withdraw_ether_command = 'withdrawEther --address=0xFFcf8FDEE72ac11b5c542428B35EEF5769C409f0 --ether=2'
    desired_parsed_item_list, priority_group, command_argument, argument_list = \
...
def test_get_send_token():
    send_token_command = 'sendToken --address=0x2D8BE6BF0baA74e0A907016679CaE9190e80dD0A ' \
                         '--address=0x5b1869D9A4C187F2EAa108f3062412ecf0526b24 --amount=1 ' \
    ...
    address_token = desired_parsed_item_list[0][1][0]
    ...
    assert address_token == '0x2D8BE6BF0baA74e0A907016679CaE9190e80dD0A'
...
def test_get_deposit_token():
    deposit_token_command = 'depositToken ' \
                            '--address=0x2D8BE6BF0baA74e0A907016679CaE9190e80dD0A --amount=1 ' \
                            '--private_key=0x6370fd033278c143179d81c5526140625662b8daa446c22ee2d73db3707e620c'
    desired_parsed_item_list, priority_group, command_argument, argument_list = \
...
def test_get_withdraw_token():
    withdraw_token_command = 'withdrawToken ' \
                             ...
                             '--address=0x22d491Bde2303f2f43325b2108D26f1eAbA1e32b --amount=1'
    desired_parsed_item_list, priority_group, command_argument, argument_list = \
